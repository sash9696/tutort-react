...
function Accordion() {
  ...
  function handleClick(id) {
    ...
    const newAccActiveId = [...accActiveId];

    //remove the id if it exists in the state
    newAccActiveId.push(id);

    setActiveId(newAccActiveId);
  }
  ...
  return (
    <div className="accordionContainer">
      {accordionData.map(function (acc, index, array) {
        return (
          <div
            className="accordion"
            key={acc.id}
